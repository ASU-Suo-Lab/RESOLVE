...
def boxes_iou_bev(boxes_a, boxes_b):
    ...
    ans_iou = boxes_a.new_zeros((boxes_a.shape[0], boxes_b.shape[0]), dtype=torch.float32)
...
def boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    overlaps_bev = boxes_a.new_zeros((boxes_a.shape[0], boxes_b.shape[0]), dtype=torch.float32)  # (N, M)
...
def boxes_aligned_iou3d_gpu(boxes_a, boxes_b):
    ...
    overlaps_bev = boxes_a.new_zeros((boxes_a.shape[0], 1), dtype=torch.float32)  # (N, 1)
