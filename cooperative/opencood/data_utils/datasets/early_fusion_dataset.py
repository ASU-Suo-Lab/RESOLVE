...
class EarlyFusionDataset(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        for cav_id, selected_cav_base in base_data_dict.items():
            ...
            object_type_stack += selected_cav_processed['object_types']
        ...
        label_dict = \
            self.post_processor.generate_label(
                ...
                anchors=anchor_box,
                mask=mask,
                gt_box_types=[object_type_stack[i] for i in unique_indices])
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        object_bbx_center, object_bbx_mask, object_ids, object_types = \
