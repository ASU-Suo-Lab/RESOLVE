...
class DSVT(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        if self.pc_type == 'Radar':
            ...
            batch_dict['radar_voxel_coords'] = voxel_info[f'voxel_coors_stage{self.stage_num - 1}']
        else:
...
class DSVTInputLayer(nn.Module):
    ...
    '''
    def __init__(self, model_cfg, pc_type=None):
        super().__init__()
...
class DSVTInputLayer_Radar(DSVTInputLayer):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
